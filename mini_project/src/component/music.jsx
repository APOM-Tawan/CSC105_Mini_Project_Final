...
export default function MediaControlCard() {
  ...
  return (
    <Card sx={{ display: 'flex',width:"25%",backgroundColor:"rgba(0,0,0,0.3)",borderRadius:"20px"}}>
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        <CardContent sx={{ flex: '1 0 auto' }}>
          <Typography component="div" variant="h5"sx={{marginTop:"5px",color:"white"}}>
            ยิ้มทั้งน้ำตา
          </Typography>
      ...
      <CardMedia
        component="img"
        sx={{ width: 150 ,padding:2,marginLeft:"40px",borderRadius:"30px", }}
        image={Billkin}
